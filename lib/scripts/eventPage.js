    ...
    if (info.menuItemId === 'blacklistWebsite') {
      ...
      chrome.tabs.query({active: true, currentWindow: true}, (tabs) => {
        chrome.tabs.sendMessage(tabs[0].id, {
          ...
          if (response) {
            console.log('sentence response', response);
...
//   console.log('localStorageSet', data);
//   if (JSON.stringy(data) === '{}'){
//     console.log('inside');
//     setup();
//   }
// });

// chrome.runtime.onMessage.addListener(setup);
